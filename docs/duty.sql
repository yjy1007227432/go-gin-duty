...
CREATE TABLE `duty_vacation` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT '' COMMENT '姓名',
  `remain_vacation` float(64) DEFAULT 0 COMMENT '剩余调休天数',
  `remain_annual_vacation` float(64) DEFAULT 0 COMMENT '剩余年休天数',
...
CREATE TABLE `duty_rest` (
 ...
 `vacation_type` tinyint(3) unsigned DEFAULT '0' COMMENT '申请调休类型，0：调休，1：年休',
 `proposer` varchar(50) DEFAULT '' COMMENT '申请人',
